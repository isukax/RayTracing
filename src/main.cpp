...
ScenePtr Scene1()
{
	...
	std::vector<HitablePtr> list
	{
		...
		std::make_shared<Box>(Vector3(265, 0, 295), Vector3(430, 330, 460), std::make_shared<LambertMaterial>(std::make_shared<ColorTexture>(Color(.75, .75, .75))))
...
int main(int argc, char** argv)
{
	...
	//Renderer renderer(1024, 768, 8, 8);
