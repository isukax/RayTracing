...
std::vector<Hitable*> scene
{
	...
	new Sphere(Vector3(1e5 + 1, 40.8, 81.6),	1e5,	new LambertMaterial(Color(0.75, 0.25, 0.25))),	// 左
	new Sphere(Vector3(-1e5 + 99, 40.8, 81.6),	1e5,	new LambertMaterial(Color(0.25, 0.25, 0.75))),	// 右
	new Sphere(Vector3(50, 40.8, 1e5),			1e5,	new LambertMaterial(Color(0.75, 0.75, 0.75))),	// 奥
	new Sphere(Vector3(50, 40.8, -1e5 + 250),	1e5,	new LambertMaterial(Color())),					// 手前
